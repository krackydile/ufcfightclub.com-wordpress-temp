...
var Lightbox = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Lightbox, [{
    ...
    key: "changeVideoURL",
    value: function changeVideoURL(element, regular, embed) {// Implemented in individual lightboxes. Empty for unsupported lightboxes
    }
  }, {
    key: "hostedVideo",
...
var PhotonicPhotoSwipe = /*#__PURE__*/function (_Lightbox) {
  ...
  (0, _createClass2.default)(PhotonicPhotoSwipe, [{
    ...
    value: function hostedVideo(a) {
      ...
      var css = a.classList.contains('photonic-launch-gallery');
    ...
    value: function initialize(selector, selfSelect) {
      ...
      containers.forEach(function (container) {
        ...
        var links = container.querySelectorAll('.photonic-launch-gallery');
        var gallery = [];
      ...
      var a = document.querySelectorAll('a.launch-gallery-photoswipe');
      var solos = Array.from(a).filter(function (elem) {
    ...
    value: function initializeForExisting() {
      ...
      document.addEventListener('click', function (e) {
        if (!(e.target instanceof Element) || !e.target.closest('a.launch-gallery-photoswipe')) {
          return;
        }

        e.preventDefault();
        var clicked = e.target.closest('a.launch-gallery-photoswipe'); //e.currentTarget;
