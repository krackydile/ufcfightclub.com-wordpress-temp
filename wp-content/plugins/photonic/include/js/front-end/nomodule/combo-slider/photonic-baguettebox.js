...
document.addEventListener('DOMContentLoaded', function () {
  ...
  lightbox.initialize();
  lightbox.initialize('.launch-gallery-baguettebox-solo'); // lightbox.initialize('.baguettebox-video'); // YouTube / Vimeo etc. do not work
      ...
      selection.forEach(function (current) {
        ...
        baguetteBox.run('#' + galleryId, {
          ...
          onChange: function onChange(idx, count) {
            var links = current.querySelectorAll('.photonic-launch-gallery');
