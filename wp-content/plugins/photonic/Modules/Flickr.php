...
//		$max_to_min = ['o','k','h','b','c'];
	...
	function build_level_1_objects($response, array $shortcode, $module_parameters = [], $options = []) {
		$photo_objects = [];
		$video_size = in_array($this->library, ['baguettebox', 'colorbox', 'fancybox', 'fancybox2', 'fancybox3', 'featherlight', 'glightbox', 'lightgallery', 'magnific', 'photoswipe', 'swipebox']) ? $shortcode['video_size'] : 'Video Player';
